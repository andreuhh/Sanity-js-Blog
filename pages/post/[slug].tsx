        ...
        <main>
            ...
            {submitted ? (
                <div className='flex flex-col py-10 my-10 bg-yellow-500 text-white max-w-2xl mx-auto'>
                    ...
                    <p>Once it has been happroved, it will appear below</p>
                </div>
            ) : (
                <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col p-5 max-w-2xl mx-auto mb-10'>
                    <h3 className='text-sm text-yellow-500'>Enjoied this article</h3>
                    ...
                    <label className='block mb-5'>
                        ...
                        <textarea
                            ...
                            placeholder='John' rows={8} />
                    </label>

                    {/** errors will retunr when fiel validation fails */}
            ...
            {/* Comments */}
            <div className='flex flex-col p-10 my-10 max-w-2xl mx-auto shadow-yellow-500 shadow space-y2'>
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
    ...
    return {
        ...
        revalidate: 60, // after 60 seconds, still update the old cache version
    }
}